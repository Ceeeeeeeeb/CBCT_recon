...
xtrue      = double(xtrue(:,201:299,:));
Rec_SART   = double(Rec_SART(:,201:299,:));
...
dictA_Atom =dictA_Atom(:,1:2:end);
dictB_Atom =dictB_Atom(:,1:2:end);
save('C:\Users\Liuhanxi\Desktop\Recon_matlab\MAT\DFR_64_4_FDK_monte','dictA_Atom','dictB_Atom')

...
%% load the dictionary
   load('C:\Users\Liuhanxi\Desktop\Recon_matlab\MAT\dictionary\DFR_64_4_FDK_monte.mat')
    ...
    ksvd_params.D1          =   dictA_Atom;
    ksvd_params.D2          =   dictB_Atom;
    clear dictA_Atom
% %% 
% %%plot the geometry
...
res_path1     = 'C:\Users\Liuhanxi\Desktop\Recon_matlab\CBCT_Scatter_Correction-main\CBCT_recon\example\MRCPs\recon\phantom 3\';
